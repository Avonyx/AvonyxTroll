...
s.SoundId = "rbxassetid://12221967" -- iPhone bildirim
s.Volume = 5
s:Play()
wait(5)
opening:Destroy()

-- Sol kutucuklar + işlev
...
-- Troll ses örnek
buttons["Sesler"].MouseButton1Click:Connect(function()
...
-- Araç renk
buttons["Araç"].MouseButton1Click:Connect(function()
...
-- Rainbow isim
buttons["Troll"].MouseButton1Click:Connect(function()
    spawn(function()
        while wait(0.2) do
